...
Object.assign(Pages, {
  ...
  _mealsGenerateDemo() {
    ...
    this._mealsDemoMenu = {
      ...
      'רביעי': {
        breakfast: 'גבינה צהובה, לחם, ירקות חתוכים',
        lunch: 'דגי אמנון, קוסקוס, סלט ערבי',
        snack: 'חטיפי גרנולה'
      },
      'חמישי': {
        breakfast: 'חביתה, לחם טוסט, סלט',
        lunch: 'תבשיל בשר עם שעועית, אורז, סלט',
        snack: 'עוגת שמרים'
      },
      'שישי': {
        breakfast: 'לחמניות, ממרחים, ירקות',
        lunch: 'מרק עוף, לחם, סלט',
        snack: 'עוגת דבש לכבוד שבת'
      }
    };
    ...
    this._mealsDemoRestrictions = [
      ...
      { name: 'דוד מזרחי', class: 'כיתה א', type: 'אלרגיה', detail: 'ביצים', severity: 'קל', icon: 'info-circle-fill', color: 'info' },
      { name: 'שמואל דהן', class: 'כיתה ב', type: 'הגבלה', detail: 'צמחוני (משפחתי)', severity: 'קבוע', icon: 'leaf', color: 'success' }
    ];
    ...
    this._mealsDemoIngredients = {
      ...
      'שניצל': ['חזה עוף 3 ק"ג', 'פירורי לחם', 'ביצים 12', 'קמח', 'שמן לטיגון'],
      'פסטה ברוטב עגבניות': ['פסטה 2 ק"ג', 'רסק עגבניות', 'בצל', 'שום', 'בזיליקום'],
      'קציצות בשר': ['בשר טחון 3 ק"ג', 'בצל 0.5 ק"ג', 'פירורי לחם', 'ביצים 6', 'פטרוזיליה'],
      'פירה': ['תפוחי אדמה 4 ק"ג', 'חמאה', 'חלב', 'מלח', 'פלפל'],
      'דגי אמנון': ['פילה אמנון 3 ק"ג', 'לימון', 'שמן זית', 'שום', 'כוסברה'],
      'קוסקוס': ['קוסקוס 2 ק"ג', 'מים', 'שמן', 'מלח', 'כורכום'],
      'תבשיל בשר עם שעועית': ['בשר לתבשיל 2.5 ק"ג', 'שעועית לבנה 1 ק"ג', 'רסק עגבניות', 'בצל', 'פפריקה'],
      'מרק עוף': ['עוף 2 ק"ג', 'גזר 0.5 ק"ג', 'סלרי', 'בצל', 'אטריות', 'מלח'],
      'שקשוקה': ['ביצים 20', 'עגבניות 2 ק"ג', 'פלפל', 'בצל', 'שום', 'כמון'],
      'חביתה': ['ביצים 20', 'חלב', 'מלח', 'פלפל'],
      'לחם': ['לחם 10 כיכרות'],
      'פירות עונה': ['תפוחים 2 ק"ג', 'בננות 2 ק"ג', 'תפוזים 2 ק"ג'],
      'עוגיות שוקולד': ['קמח 1 ק"ג', 'סוכר 0.5 ק"ג', 'חמאה', 'שוקולד צ\'יפס', 'ביצים 4'],
      'עוגת שמרים': ['קמח 1 ק"ג', 'שמרים', 'סוכר', 'שמן', 'ביצים 4', 'מלח'],
      'עוגת דבש לכבוד שבת': ['קמח 1 ק"ג', 'דבש 0.5 ק"ג', 'סוכר', 'שמן', 'ביצים 4', 'סודה', 'קינמון']
    };
  },
