...
Object.assign(Pages, {
  ...
  _umDemoData() {
    return [
      {'\u05E9\u05DD':'\u05D9\u05D5\u05E1\u05E3 \u05E9\u05E0\u05D9\u05D9\u05D3\u05E8','\u05D0\u05D9\u05DE\u05D9\u05D9\u05DC':'admin@bht.org','\u05EA\u05E4\u05E7\u05D9\u05D3':'admin','\u05DB\u05E0\u05D9\u05E1\u05D4_\u05D0\u05D7\u05E8\u05D5\u05E0\u05D4':'22/04/2026 09:30','\u05DE\u05D6\u05D4\u05D4':'demo1'},
      {'\u05E9\u05DD':'\u05E8\u05D1\u05E7\u05D4 \u05DB\u05D4\u05DF','\u05D0\u05D9\u05DE\u05D9\u05D9\u05DC':'rivka@bht.org','\u05EA\u05E4\u05E7\u05D9\u05D3':'secretary','\u05DB\u05E0\u05D9\u05E1\u05D4_\u05D0\u05D7\u05E8\u05D5\u05E0\u05D4':'22/04/2026 08:15','\u05DE\u05D6\u05D4\u05D4':'demo2'},
      {'\u05E9\u05DD':'\u05D0\u05D1\u05E8\u05D4\u05DD \u05DC\u05D5\u05D9','\u05D0\u05D9\u05DE\u05D9\u05D9\u05DC':'avraham@bht.org','\u05EA\u05E4\u05E7\u05D9\u05D3':'teacher','\u05DB\u05E0\u05D9\u05E1\u05D4_\u05D0\u05D7\u05E8\u05D5\u05E0\u05D4':'21/04/2026 14:00','\u05DE\u05D6\u05D4\u05D4':'demo3'},
      {'\u05E9\u05DD':'\u05D3\u05D5\u05D3 \u05D9\u05E9\u05E8\u05D0\u05DC\u05D9','\u05D0\u05D9\u05DE\u05D9\u05D9\u05DC':'david@parent.com','\u05EA\u05E4\u05E7\u05D9\u05D3':'parent','\u05DB\u05E0\u05D9\u05E1\u05D4_\u05D0\u05D7\u05E8\u05D5\u05E0\u05D4':'20/04/2026 18:00','\u05DE\u05D6\u05D4\u05D4':'demo4'},
      {'\u05E9\u05DD':'\u05E9\u05E8\u05D4 \u05E4\u05E8\u05D9\u05D3\u05DE\u05DF','\u05D0\u05D9\u05DE\u05D9\u05D9\u05DC':'sara@parent.com','\u05EA\u05E4\u05E7\u05D9\u05D3':'parent','\u05DB\u05E0\u05D9\u05E1\u05D4_\u05D0\u05D7\u05E8\u05D5\u05E0\u05D4':'19/04/2026 16:30','\u05DE\u05D6\u05D4\u05D4':'demo5'}
    ];
  },
  _logDemoData() {
    const actions = [
  ...
  cameras() {
    ...
    const onLan = location.hostname === 'localhost' || location.hostname.startsWith('192.168.') || location.hostname.startsWith('10.') || location.hostname === '127.0.0.1';
    if (!onLan) {
      return `<div class="page-header"><h1><i class="bi bi-camera-video-fill me-2"></i>\u05DE\u05E6\u05DC\u05DE\u05D5\u05EA</h1></div><div class="card p-5 text-center"><i class="bi bi-wifi-off fs-1 text-muted d-block mb-3"></i><h4>\u05D6\u05DE\u05D9\u05DF \u05E8\u05E7 \u05DE\u05D4\u05E8\u05E9\u05EA \u05D4\u05DE\u05E7\u05D5\u05DE\u05D9\u05EA</h4><p class="text-muted">\u05DE\u05E6\u05DC\u05DE\u05D5\u05EA \u05D4AVIVID \u05D6\u05DE\u05D9\u05E0\u05D5\u05EA \u05E8\u05E7 \u05DB\u05E9\u05E0\u05D9\u05D2\u05E9\u05D9\u05DD \u05DE\u05EA\u05D5\u05DA \u05E8\u05E9\u05EA \u05D4\u05DE\u05D5\u05E1\u05D3. \u05D1\u05E2\u05EA \u05D2\u05D9\u05E9\u05D4 \u05DE\u05D4\u05D0\u05D9\u05E0\u05D8\u05E8\u05E0\u05D8 (GitHub Pages) \u05D4\u05D3\u05E4\u05D3\u05E4\u05DF \u05D7\u05D5\u05E1\u05DD \u05D1\u05E7\u05E9\u05D5\u05EA HTTP \u05DE\u05EA\u05D5\u05DA \u05D3\u05E3 HTTPS.</p><div class="alert alert-info text-start mt-3 mb-0"><strong>\u05E4\u05EA\u05E8\u05D5\u05DF:</strong> \u05E4\u05EA\u05D7 \u05D0\u05EA \u05D4\u05D0\u05E4\u05DC\u05D9\u05E7\u05E6\u05D9\u05D4 \u05D3\u05E8\u05DA \u05DB\u05EA\u05D5\u05D1\u05EA \u05DE\u05E7\u05D5\u05DE\u05D9\u05EA, \u05DC\u05D3\u05D5\u05D2\u05DE\u05D4 <code dir="ltr">http://192.168.1.100:5050</code></div></div>`;
    }
    const cams = [{name:'\u05DB\u05E0\u05D9\u05E1\u05D4',path:'/cam/1'},{name:'\u05D7\u05E6\u05E8',path:'/cam/2'},{name:'\u05DB\u05D9\u05EA\u05D4 \u05D0',path:'/cam/3'},{name:'\u05DB\u05D9\u05EA\u05D4 \u05D1',path:'/cam/4'}];
    return `<div class="page-header d-flex justify-content-between align-items-start flex-wrap gap-2"><div><h1><i class="bi bi-camera-video-fill me-2"></i>\u05DE\u05E6\u05DC\u05DE\u05D5\u05EA</h1></div><button class="btn btn-outline-primary btn-sm" onclick="Pages.refreshCameras()"><i class="bi bi-arrow-clockwise me-1"></i>\u05E8\u05E2\u05E0\u05D5\u05DF</button></div><div class="row g-3">${cams.map((c,i)=>`<div class="col-md-6"><div class="camera-feed" id="cam-${i}"><img src="${baseUrl}${c.path}/snapshot?t=${Date.now()}" alt="${c.name}" onerror="this.style.display='none';this.parentElement.innerHTML+='<div class=\\'text-center text-white p-5\\'><i class=\\'bi bi-camera-video-off fs-1\\'></i><br><small>\u05DC\u05D0 \u05D6\u05DE\u05D9\u05DF</small></div>'"><div class="camera-label"><i class="bi bi-circle-fill text-danger me-1" style="font-size:.5rem"></i>${c.name}</div></div></div>`).join('')}</div><div class="card p-3 mt-3"><a href="${baseUrl}" target="_blank" rel="noopener" class="btn btn-primary"><i class="bi bi-box-arrow-up-left me-1"></i>\u05E4\u05EA\u05D7 \u05DE\u05E2\u05E8\u05DB\u05EA \u05DE\u05E6\u05DC\u05DE\u05D5\u05EA</a></div>`;
  },
  camerasInit() { if (this._camInterval) clearInterval(this._camInterval); this._camInterval = setInterval(() => { if (App.currentPage !== 'cameras') { clearInterval(this._camInterval); this._camInterval = null; return; } document.querySelectorAll('.camera-feed img').forEach(img => { const src=img.src.split('?')[0]; img.src=src+'?t='+Date.now(); }); }, 10000); },
